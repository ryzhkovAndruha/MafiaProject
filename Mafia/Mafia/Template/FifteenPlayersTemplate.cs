...
{
    public class FifteenPlayersTemplate : ITemplate
    {
        int ITemplate.SuspectedMafiasInGameCount { get { return 4; } }
        ...
        int ITemplate.SuspectedCitizensInGameCount { get { return 7; } }
