...
{
    public class ElevenPlayersTemplate : ITemplate
    {
        int ITemplate.SuspectedMafiasInGameCount { get { return 2; } }
        ...
        int ITemplate.SuspectedCitizensInGameCount { get { return 5; } }
